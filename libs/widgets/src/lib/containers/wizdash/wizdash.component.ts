...
import { fadeOutAnimation } from "@coord-angular/animations";
...
import { RealtimeUsersWidgetData, RealtimeUsersWidgetPages } from '../../components/realtime-users-widget/realtime-users-widget.interface';
