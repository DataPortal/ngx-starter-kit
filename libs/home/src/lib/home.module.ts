...
import { ThemePickerModule } from '@coord-angular/theme-picker';
...
import { ScrollToTopModule } from '@coord-angular/scroll-to-top';
import { SvgViewerModule } from '@coord-angular/svg-viewer';
