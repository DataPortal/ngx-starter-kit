...
import { AuthModule, AuthState } from '@coord-angular/auth';
import { NavigatorModule, MenuState } from '@coord-angular/navigator';
import { NgxsWebsocketPluginModule } from '@coord-angular/socketio-plugin';
